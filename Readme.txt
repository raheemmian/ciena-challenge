...
After running your command line should look something like this: 

Django version 3.2.3, using settings 'ciena.settings'
Starting development server at http://127.0.0.1:8000/

Copy the development server link into ur browser: http://127.0.0.1:8000/

The web app should be up and running now, Have fun!

Start: This button will start the acquisition untill the Stop button is pressed.
Stop: Puts OSA to idle and then plots the trace.
Single: Retrieves a single trace from the OSA
